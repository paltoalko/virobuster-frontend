...
const photos = [
  { id: 0, src: require('../img/steribase0.png') },
  { id: 1, src: require('../img/steribase1.png') },
  { id: 2, src: require('../img/steribase2.png') },
  { id: 3, src: require('../img/steribase3.png') },
  { id: 4, src: require('../img/steribase4.png') },
  { id: 5, src: require('../img/steribase5.png') },
];
...
const Photos: React.FC<{}> = ({}) => {
  ...
  useEffect(() => {
    let object = photos.find((el) => el.id === active);
